...
public class Player_main : MonoBehaviour
{
    ...
    {
        if (other.gameObject.name == "obj_rotate")
        {
            Obj_change_direction obj_rotate = other.gameObject.GetComponent<Obj_change_direction>();
            obj_rotate.show_arrow();
            obj_rotate.change_direction();
        }
    }
